      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r border-slate-200 fixed h-full z-20">
        <div className="p-6">
          <Link href="/" className="flex items-center gap-2 group">
            <ShieldAlert className="h-8 w-8 text-green-600 transition-transform group-hover:scale-110" />
            <span className="font-bold text-2xl tracking-tight text-slate-900">
              ResQ<span className="text-green-600">Net</span>
            </span>
          </Link>
          <div className="mt-2 px-1">
            <span className="text-xs font-semibold text-green-600 uppercase tracking-wider bg-green-50 px-2 py-1 rounded-md">
              Volunteer Hub
            </span>
          </div>
        </div>
        ...
        <div className="p-4 border-t border-slate-200">
          <div className="flex items-center gap-3 px-4 py-2">
            ...
            <div className="flex flex-col">
              <span className="text-sm font-semibold text-slate-900">Volunteer Sam</span>
