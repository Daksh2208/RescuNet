...
export default function RegisterPage() {
  const [role, setRole] = useState<"citizen" | "rescue" | "admin">("citizen");
            ...
            <div>
              <button
                ...
                className={`w-full flex justify-center py-2.5 px-4 border border-transparent rounded-lg shadow-sm text-sm font-medium text-white transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 ${
                  role === "rescue" ? "bg-blue-600 hover:bg-blue-700 focus:ring-blue-500" : 
                  role === "admin" ? "bg-purple-600 hover:bg-purple-700 focus:ring-purple-500" : 
                  "bg-red-600 hover:bg-red-700 focus:ring-red-500"
                }`}
              >
                Register as {role === "citizen" ? "Citizen" : role === "rescue" ? "Rescue Team" : "Administrator"}
              </button>
            </div>
          </form>
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-slate-700">
                  {role === "citizen" ? "Need to report an emergency?" : role === "rescue" ? "Ready to deploy?" : "Applying for admin access?"}
                </span>
              </div>
            </div>
